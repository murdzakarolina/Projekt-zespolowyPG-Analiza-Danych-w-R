...
VIM::aggr(oceanbuoys, col=c('navyblue','red'), numbers=TRUE, sortVars=TRUE, labels=names(oceanbuoys), cex.axis=.7, gap=3, ylab=c("Procent braków danych","Wzorzec braków danych"))
