...
- Sprawdzanie zakresu wartości: Upewnienie się, że wartości liczbowe mieszczą się w określonym zakresie (np. wiek powinien być większy niż 15 i mniejszy niż 50).

- Sprawdzanie typów danych: Upewnienie się, że dane są w odpowiednim formacie (np. daty powinny być w formacie "YYYY-MM-DD").

-Tu coś jeszcze trzeba dopisac - kreatywnosc zostawiam wam (powinno byc 4 myslniki)
...
Zdefiniujmy szereg reguł, które muszą spełniać nasze dane *musimy podmienic na nasze, zgodnie z regułami wyzej
...
Czy zbiór danych spełnia te reguły? (tez podmienic na nasze)
